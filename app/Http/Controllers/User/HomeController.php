...
//        $product_cat_homes=ProductCategory::where('status_home','active')->orderBy('id','desc')->take(4)->get();
        ...
        return view('user.index',compact('sliders','menu_slider_downs','about','products','setting','abouts_f','certs','partners','blogs','contact_info','ProductCategory2','ProductCategory'));
    }
