                            ...
                            <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <input class="form-control" id="short_text" name="short_text" value="{{ old('short_text') }}" required/>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <input type="text" class="form-control" id="keyword" name="keyword"
                                               value="{{ old('keyword') }}" placeholder="با کاما '،' کلمات را ازهم جدا کنید"/>
                            ...
                            <div class="form-group{{ $errors->has('dis') ? ' has-error' : '' }}">
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <input type="text" class="form-control" id="dis" name="dis" value="{{ old('dis') }}"/>
                                        @if ($errors->has('dis'))
